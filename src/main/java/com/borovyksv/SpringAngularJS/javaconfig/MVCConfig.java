...
import com.borovyksv.SpringAngularJS.mvc.interceptors.SiteInterceptor;
...
@Configuration
@ComponentScan(basePackages = {"com.borovyksv.SpringAngularJS.mvc"}) //<context:component-scan base-package=''>
